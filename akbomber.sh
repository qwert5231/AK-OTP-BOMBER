...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing AK BOMBER'
    else
        figlet TBomb
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mAK TEC HUNT3R \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border AK BOMBER
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/AKBOMBER \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/AKTECHUNT3r \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By AK TEC HUNT3R > .update
